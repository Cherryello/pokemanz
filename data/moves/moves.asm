...
; entries correspond to constants/move_constants.asm
	...
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,    PHYSICAL,  75, 15,   0
	...
	move SWEET_KISS,   EFFECT_CONFUSE,             0, FAIRYT,   STATUS,    75, 10,   0
	...
	move CHARM,        EFFECT_ATTACK_DOWN_2,       0, FAIRYT,   STATUS,   100, 20,   0
	...
	move MOONLIGHT,    EFFECT_MOONLIGHT,           0, FAIRYT,   STATUS,   100,  5,   0
	...
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        15, WATER,    SPECIAL,   85, 15,   0
