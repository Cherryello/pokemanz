	tilepal 0, GRAY, BROWN, BROWN, RED, BROWN, PRIORITY_ROOF, PRIORITY_ROOF, PRIORITY_ROOF
	tilepal 0, PRIORITY_ROOF, PRIORITY_ROOF, YELLOW, YELLOW, YELLOW, GRAY, BROWN, GRAY
	tilepal 0, GRAY, BROWN, PRIORITY_ROOF, BROWN, WATER, PRIORITY_ROOF, PRIORITY_ROOF, PRIORITY_ROOF
	tilepal 0, PRIORITY_ROOF, PRIORITY_ROOF, GRAY, BROWN, BROWN, GRAY, BROWN, GRAY
	...
	tilepal 0, PRIORITY_ROOF, GRAY, GRAY, GRAY, GRAY, GREEN, GREEN, GRAY
	tilepal 0, GREEN, GREEN, GRAY, GRAY, GRAY, GRAY, BROWN, BROWN
	tilepal 0, BROWN, BROWN, GRAY, BROWN, PRIORITY_GRAY, PRIORITY_GRAY, PRIORITY_GRAY, RED
	tilepal 0, GREEN, GREEN, GREEN, PRIORITY_ROOF, BROWN, BROWN, BROWN, BROWN
	tilepal 0, BROWN, BROWN, PRIORITY_GRAY, BROWN, GRAY, GRAY, PRIORITY_GRAY, PRIORITY_GRAY
