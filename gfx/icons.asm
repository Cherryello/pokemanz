...
DuckyIcon:	    INCBIN "gfx/icons/ducky.2bpp"
DucklyIcon:		INCBIN "gfx/icons/duckly.2bpp"
DuckleafIcon:	INCBIN "gfx/icons/duckleaf.2bpp"
BeaireIcon: 	INCBIN "gfx/icons/beaire.2bpp"
FiearIcon:	    INCBIN "gfx/icons/fiear.2bpp"
GrizzlireIcon:	INCBIN "gfx/icons/grizzlire.2bpp"
SquizzyIcon:	INCBIN "gfx/icons/squizzy.2bpp"
SquashyIcon:	INCBIN "gfx/icons/squashy.2bpp"
BatzyIcon:		INCBIN "gfx/icons/batzy.2bpp"
